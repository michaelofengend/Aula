...
import { Tabs, Tab, Container, Row, Col, Form, Button, Card, Navbar, Nav, Table, ListGroup } from 'react-bootstrap';
  ...
  <div>
    ...
    <Card>
      <Card.Body>
        ...
        <Card.Subtitle className="mb-2 text-muted">Professor Name</Card.Subtitle>
...
const StudentForum = () => (
  <div>
    ...
    <div className="forum-section">
      ...
      <p>Discuss courses, share experiences, and connect with fellow students.</p>
        ...
        <Navbar bg="light" expand="lg" className="v10_4">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ml-auto">
              <Nav.Link href="/login" className="v10_21">Welcome Michael Ofengenden</Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Navbar>
        <Container>
